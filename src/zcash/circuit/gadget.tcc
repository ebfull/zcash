...
private:
    ...
    std::unique_ptr<multipacking_gadget<FieldT>> unpacker;

    std::unique_ptr<digest_variable<FieldT>> zk_merkle_root;
    std::unique_ptr<digest_variable<FieldT>> zk_h_sig;
    boost::array<std::unique_ptr<digest_variable<FieldT>>, NumInputs> zk_input_nullifiers;
    boost::array<std::unique_ptr<digest_variable<FieldT>>, NumInputs> zk_input_hmacs;
    boost::array<std::unique_ptr<digest_variable<FieldT>>, NumOutputs> zk_output_commitments;
...
public:
    ...
    void alloc_uint256(
        ...
        std::unique_ptr<digest_variable<FieldT>>& var
    ) {
